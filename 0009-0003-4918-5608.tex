...
\begin{itemize}
    ...
    \item \textbf{Statistically Validated Benchmark Corpus:} An expanded, leak-free multi-class corpus of 3,691 images with source-partitioned blind testing ($N=233$), 95\% bootstrap confidence intervals, and McNemar quantization fidelity testing.
...
Standard CPU Latency & 42.5 ms & 11.2 ms & -73.6\% \\
